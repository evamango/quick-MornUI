    ...
    int       nCmdShow)
{
    ...
    return UiPlayer::createAndRun();
}

int UiPlayer::createAndRun(void)
{
    UiPlayer *host = UiPlayer::sharedInstance();
    int ret = host->run();
    UiPlayer::purgeSharedInstance();
    return ret;
}

UiPlayer *UiPlayer::s_sharedInstance = NULL;

UiPlayer *UiPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new UiPlayer();
    }
    return s_sharedInstance;
}

void UiPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
void UiPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void UiPlayer::createViewMenu(void)
{
...
void UiPlayer::updateWindowTitle(void)
{
}

void UiPlayer::relaunch(void)
{
...
void UiPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void UiPlayer::onFileOpenProject(void)
{
...
void UiPlayer::onFileProjectConfig(void)
{
...
void UiPlayer::onFileRelaunch(void)
{
    relaunch();
}

void UiPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void UiPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void UiPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void UiPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void UiPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT UiPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    UiPlayer *host = UiPlayer::sharedInstance();
...
INT_PTR CALLBACK UiPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
